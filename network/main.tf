...
resource "aws_iam_instance_profile" "eks_terraform_profile_ec2" {
  name = "eks_terraform_profile_ec2"
...
module "ec2_instance" {
  ...
  iam_instance_profile = aws_iam_instance_profile.eks_terraform_profile_ec2.name
  user_data = <<EOF
    #!/bin/bash
